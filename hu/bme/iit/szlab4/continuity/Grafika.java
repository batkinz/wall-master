...
public class Grafika{
	...
	// átveszi a belső menü gombjait és lekezeli őket
	public void belsoMenu(Allapot allapot){
		if (allapot == Allapot.mentkilep){
			...
			try {
				...
				JOptionPane.showMessageDialog(frmWallMaster,"Nem tölthető be a kért pálya", "Hiba", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
	...
	// ha a külső menüből érkezett esemény
	...
	// ha a készítők fülből érkezett esemény
	...
	// a metódus meghívásával megjelenítjuk a belső menüt a játék közben
