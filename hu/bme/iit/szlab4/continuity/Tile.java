...
public class Tile {
	...
	// pályaelem lista feltöltő metódus
	...
	// és elvégzi a megfelelő műveleteket
	...
	public void korrekcio(Jatekos j) {
		...
		if (irany == 0) {
			...
			// és az ugrás változóját 0-zuk, hogy innentől kezdve ne menjen bele többször ebbe a tile-ba
		} else if (irany == 90) {
	...
	public boolean metszette(Jatekos j) {
		...
		// mind a 4 pontot ellenőrizzük, ha bármelyik pont benne ban a tile-ban 
