...
public class Fal extends Palyaelem{
	...
	public boolean korrekcio(Jatekos j){
		...
		// mivel azt szeretnénk, hogy a double koorinátát "minél messzebbre kerekítsük" a pályaelemtől, ezért
